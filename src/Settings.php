				...
				<div class="e-wrapper">
					<div class="e-content e-box">
						...
						<div class="e-tabPane hidden" data-tab="email">
							...
							$this->checkbox( 'no_password_reset_emails', __( 'Disable admin email notification when users reset passwords', 'falcon' ), __( 'Do not send emails to admins when users reset their passwords on your website.', 'falcon' ) );
							?>
						</div>
