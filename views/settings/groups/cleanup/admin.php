...
$this->checkbox( 'no_footer_text', __( 'Remove admin footer text', 'falcon' ), __( 'Remove the footer text in the admin area.', 'falcon' ) );
$this->checkbox( 'no_wp_logo', __( 'Remove WordPress admin bar logo', 'falcon' ), __( 'Remove the WordPress logo from the admin bar.', 'falcon' ) );
